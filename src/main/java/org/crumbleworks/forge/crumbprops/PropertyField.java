...
public class PropertyField {
	...
	public PropertyField(Object classInstance, Field field, Object convertersInstance, Method convertToType,
	...
	/**
	 * @return the value as stored on the managed {@link PropertyFile}-annotated
	 *         class' instance
	 */
	...
	/**
	 * @return the value stored on the managed {@link PropertyFile}-annotated class'
	 *         instance, converted <b>to</b> a string. Or the default value, if any.
	 */
	...
	/**
	 * Sets the value on the managed {@link PropertyFile}-annotated class' instance.
	 */
